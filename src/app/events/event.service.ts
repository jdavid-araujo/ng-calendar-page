...
export class EventService {
  ...
  getEventsMock(): Array<Event> {
    ...
    events.push(new Event(5, 'Event5', new Country('United Kingdom', 'Liverpool', 'https://vanhackblobstorageprod.blob.core.windows.net/img/events/thumbnail/9e7bf694-b476-4b93-8981-68c36fbc7235.jpg'), new AccountType(1, 'Premium'), new EventType(3, 'VanHackathons'),new Date('01-01-2020'), new Date('01-10-2020'), 'The event is about......'));
    events.push(new Event(6, 'Event6', new Country('United Kingdom', 'London', 'https://vanhackblobstorageprod.blob.core.windows.net/img/events/thumbnail/4d8170b8-9ba6-4365-82ae-f028f02b281c.jpg'), new AccountType(0, 'Non-Premium'), new EventType(0, 'Leaps'),new Date('01-02-2020'), new Date('01-08-2020'), 'The event is about......'));
    ...
    events.push(new Event(8, 'Event8', new Country('Canada', 'Montreal', 'https://vanhackblobstorageprod.blob.core.windows.net/img/events/thumbnail/351665ed-4492-4749-ba43-c8e58f14888e.jpg'), new AccountType(0, 'Non-Premium'), new EventType(0, 'Leaps'),new Date('12-02-2019'), new Date('01-20-2020'), 'The event is about......'));
    events.push(new Event(9, 'Event9', new Country('Canada', 'Toronto', 'https://vanhackblobstorageprod.blob.core.windows.net/img/events/thumbnail/1e2d6be2-b729-4ebb-8d0c-2c75035efbee.jpg'), new AccountType(0, 'Non-Premium'), new EventType(0, 'Leaps'),new Date('10-21-2019'), new Date('10-30-2019'), 'The event is about......'));
    events.push(new Event(10, 'Event10', new Country('Canada', 'Toronto', 'https://vanhackblobstorageprod.blob.core.windows.net/img/events/thumbnail/1e2d6be2-b729-4ebb-8d0c-2c75035efbee.jpg'), new AccountType(0, 'Non-Premium'), new EventType(0, 'Leaps'),new Date('11-29-2019'), new Date('11-30-2019'), 'The event is about......'));
    events.push(new Event(11, 'Event11', new Country('Canada', 'Montreal', 'https://vanhackblobstorageprod.blob.core.windows.net/img/events/thumbnail/1e2d6be2-b729-4ebb-8d0c-2c75035efbee.jpg'), new AccountType(1, 'Premium'), new EventType(0, 'VanHackathons'),new Date('11-28-2019'), new Date('11-31-2019'), 'The event is about......'));
