...
import { TodoItemFlatNode } from 'src/app/shared/todo-item-flat-node.model';
import { FlatTreeControl } from '@angular/cdk/tree';
import { MatTreeFlattener, MatTreeFlatDataSource } from '@angular/material/tree';
import { SelectionModel } from '@angular/cdk/collections';
import { TodoItemNode } from 'src/app/shared/todo-item-node.model';
...
export class EventLeftSideMenuComponent implements OnInit {
  ...
  todoItemSelectionToggle(node: TodoItemFlatNode): void {
    ...
    this.filterEvent.eventLocation = this.checklistSelection.selected;
    this.filterEventEmitter.emit(this.filterEvent);
  }
